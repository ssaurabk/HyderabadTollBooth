...
public class Vehicle67A extends Vehicle {

	Vehicle67A(String commuterName, String vehicleNumber, int advancedAmount) {
		super(commuterName, vehicleNumber, advancedAmount);
	}

	@Override
	public void updateAdvanceAmount()
		...
		int tripFare = getFare(entryPoint, exitPoint);
	...
	protected int getFare(EntryPoints entryPoint, ExitPoints exitPoint) {
		...
		int fare = FareAndDistance.VEHICLE_67A_BASE_FARE
				+ (distance * FareAndDistance.VEHICLE_67A_PER_KM_FARE);
		return fare;
	}
}
